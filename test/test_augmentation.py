...
# dest_dir_lab and src_dir_lab included for labels
    aug_directory(src_dir, dest_dir, src_dir_lab, dest_dir_lab, col_jit = 0, rand_rot = 0.5, rand_hflip = 0.5) # Test with % probability for colorjitter, % for random rotation and % for random horizontal flip
    return
